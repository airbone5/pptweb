...
illegal:"[^\\s\\}]"}}}());hljs.registerLanguage("stata",function(){"use strict";return function(e){return{
...
begin:'""'}],starts:a
},e.COMMENT("^\\s*\\%\\{\\s*$","^\\s*\\%\\}\\s*$"),e.COMMENT("\\%","$")]}}}());hljs.registerLanguage("sas",function(){"use strict";return function(e){return{
...
},e.COMMENT("\\*",";"),e.C_BLOCK_COMMENT_MODE]}}}());hljs.registerLanguage("apache",function(){"use strict";return function(e){
...
}],illegal:/\S/}}}());hljs.registerLanguage("r",function(){"use strict";return function(e){
...
begin:"%",end:"%"},{begin:"`",end:"`",contains:[{begin:/\\./}]}]}}}());hljs.registerLanguage("cmake",function(){"use strict";return function(e){return{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]}}}());hljs.registerLanguage("perl",function(){"use strict";return function(e){var n={
$pattern:/[\w.]+/,
